...
let arrTest1 = ["cat", "dog", "parrot", "horse"];

//ОТВЕТ

console.log(arrTest1.indexOf("parrot"));
console.log(arrTest1.findIndex((item) => item == "parrot"));

//Удаление элементов из массива

let arrTest2 = ["cat", "dog", "parrot", "horse", "fish", "chicken", "lion"];

//ОТВЕТ

arrTest2.splice(arrTest2.indexOf("fish"), 1);

arrTest2.splice(arrTest2.indexOf("cat"), 1);
//or
arrTest2.shift();

arrTest2.splice(arrTest2.length - 2, 2);
console.log(arrTest2);

//Фильтрация массива

let arrTest3 = [31, 10, "chicken", 9, "fish", 10];

//ОТВЕТ

let onlyStr = arrTest3.filter((item) => typeof item === "string");
console.log(onlyStr);

let onlyTen = arrTest3.filter((item) => item == 10);
